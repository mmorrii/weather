...
import GridNow from "../components/grid/GridNow";
import PrecipitationBlockNow from "../components/PrecipitationBlockNow";
...
const Home = ({ weather, selectedOption, cityData }) => {
	return (
		<main className="flex-auto mb-8">
			...
			/>
			<motion.div
				className="flex justify-between max-lg:flex-col-reverse gap-4 max-sm:gap-2 mb-4 max-sm:mb-2"
