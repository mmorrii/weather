...
const OpenCard = ({ forecast, i }) => {
   return (
      <li className="flex-[0_0_auto] relative dark:bg-zinc-600/40 bg-white rounded-lg p-[4px_10px_8px] mb-[8px]">
   ...
   return (
      <li className="flex-[1_1_auto] mb-[8px]">
         <button type="button" onClick={() => setOpenCard(i)}
                 className="dark:bg-zinc-600/40 dark:hover:bg-zinc-600/60 bg-white hover:bg-white/60 duration-200 rounded-lg p-[4px_10px_6px] w-full h-full flex flex-col items-center justify-between"
         >
